...
# make the materials coloured so we can use it to colour the plots
n_colours <- length(unique(sc$Material))
the_colours <- RColorBrewer::brewer.pal(n_colours, "Set1")

sc$Material_colour <- as.character(
  factor(sc$Material, labels = the_colours))

plot(sc.plot,
  withPositions = TRUE,
  fillCols = sc$Material_colour,
  yaxt = "n", 
  xaxt = "n",
  ylab = "Layer", 
  main = "", 
...
legend("topleft", 
       pch = legend_pch, 
       cex = legend_cex,
       col= unique(sc$Material_colour) ,
       legend = unique(sc$Material))
```
...
# make the materials coloured so we can use it to colour the plots
n_colours <- length(unique(scc$Material))
the_colours <- RColorBrewer::brewer.pal(n_colours, "Set1")

scc$Material_colour <- as.character(
  factor(scc$Material, labels = the_colours))

plot(scc.plot,
  withPositions = TRUE,
  fillCols = scc$Material_colour, 
  yaxt = "n", 
  xaxt = "n",
  ylab = "Layer", 
  main = "", 
...
legend("topleft", 
       pch = legend_pch, 
       cex = legend_cex,
       col= unique(scc$Material_colour) ,
       legend = unique(scc$Material))
...
# make the materials coloured so we can use it to colour the plots
n_colours <- length(unique(bvc$Material))
the_colours <- RColorBrewer::brewer.pal(n_colours, "Set1")

bvc$Material_colour <- as.character(
  factor(bvc$Material, labels = the_colours))

plot(bvc.plot,
  withPositions = TRUE,
  fillCols = bvc$Material_colour,
  yaxt = "n", 
  xaxt = "n",
  ylab = "Layer", 
  main = "", 
...
legend("topleft", 
       pch = legend_pch, 
       cex = legend_cex,
       col= unique(bvc$Material_colour) ,
       legend = unique(bvc$Material))
```
...
# make the materials coloured so we can use it to colour the plots
n_colours <- length(unique(bvc_rice$Material))
the_colours <- RColorBrewer::brewer.pal(3, "Set1")[1]

bvc_rice$Material_colour <- as.character(
  factor(bvc_rice$Material, labels = the_colours))

plot(bvcr.plot,
  withPositions = TRUE,
  fillCols = bvc_rice$Material_colour,
  yaxt = "n", 
  xaxt = "n",
  ylab = "Layer", 
  main = "", 
...
legend("topright", 
       pch = legend_pch, 
       cex = legend_cex,
       col= unique(bvc_rice$Material_colour) ,
       legend = unique(bvc_rice$Material))
...
# make the materials coloured so we can use it to colour the plots
n_colours <- length(unique(nnt$Material))
the_colours <- RColorBrewer::brewer.pal(n_colours, "Set1")

nnt$Material_colour <- as.character(
  factor(nnt$Material, labels = the_colours))

plot(nnt.plot,
  withPositions = TRUE,
  fillCols = nnt$Material_colour,
  yaxt = "n", 
  xaxt = "n",
  ylab = "Layer", 
  main = "", 
...
legend("topleft", 
       pch = legend_pch, 
       cex = legend_cex,
       col= unique(nnt$Material_colour) ,
       legend = unique(nnt$Material))
...
# make the materials coloured so we can use it to colour the plots
n_colours <- length(unique(nnt_green$Material))
the_colours <- RColorBrewer::brewer.pal(3, "Set1")[1:n_colours]

nnt_green$Material_colour <- as.character(
  factor(nnt_green$Material, labels = the_colours))

plot(nntg.plot,
  withPositions = TRUE,
  fillCols = nnt_green$Material_colour,
  xaxt = "n",
  yaxt = "n",
  ylab = "Layer", 
  main = "", 
...
legend("topleft", 
       pch = legend_pch, 
       cex = legend_cex,
       col= unique(nnt_green$Material_colour) ,
       legend = unique(nnt_green$Material))
```
